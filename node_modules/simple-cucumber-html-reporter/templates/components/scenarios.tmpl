    ...
    <div class="x_panel" style="height: auto;">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                ...
                <li>
                    <span class="step not-defined-background" data-toggle="tooltip" title="Scenario has no step implementation.">
                        <%= scenario.notdefined %>
                    </span>
                </li>
                <% } %>
                <% if (suite.displayDuration) { %>
                    <li>
                        <span style="font-size:1.2em;color:blue"> Duration:</span>
                        <span style="padding-right:5em;color:blue"><%= scenario.time %></span>
                    </li>
                <% } %>
            </ul>
