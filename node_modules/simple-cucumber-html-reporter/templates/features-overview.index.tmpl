...
<html lang="en">
    <head>
        ...
        <title>Simple BDD HTML Report</title>
    ...
    <body>
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <p class="navbar-text"><%= suite.reportName %></p>
            </div>
        </nav>
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                ...
                                <%= suite.scenarios.pendingPercentage %>,
                                <%= suite.scenarios.skippedPercentage %>,
                                <%= suite.scenarios.ambiguousPercentage %>,
                                <%= suite.scenarios.notdefinedPercentage %>,
                            ],
                            backgroundColor: [
                                "#26B99A",
                                "#E74C3C",
        ...
        <div class="created-by">
            <p>Created with <i class="fa fa-heart" style="color:red"></i> by Rahul</p>
            <a href="https://www.linkedin.com/in/rahul-upadhyay/" target="_blank"><i class="fa fa-linkedin-square fa-2x"></i></a>
        </div>
